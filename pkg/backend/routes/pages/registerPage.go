...
import (
	...
	desktop_page_register "github.com/Mateus-MS/Xeubiart.git/frontend/desktop/pages/register"
	mobile_page_home "github.com/Mateus-MS/Xeubiart.git/frontend/mobile/pages/home"
	"github.com/gin-gonic/gin"
)

func RegisterPageRoute() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := desktop_page_register.Index().Render(c.Request.Context(), c.Writer)
		if err != nil {
			c.String(http.StatusInternalServerError, "render error: %v", err)
		}
	}
